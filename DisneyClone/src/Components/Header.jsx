    ...
    <div className=' flex w-full h-[80px] text-white'>
        ...
        <div className='lg:w-1/2 md:w-1/2 w-full h-full flex items-center justify-end pr-[20px]'>
            ...
            lg:hidden md:hidden px-[2px] py-[10px]
             focus-within:border-[1px] ${show ? "border-gray-500" : "border-transparent"} rounded-sm`}>
                <BsThreeDotsVertical />
            </button>
        ...
        {show && <div 
        className='w-full h-[300px] opacity-[0.9]  
        lg:hidden md:hidden bg-[#2a2c35] absolute z-10
